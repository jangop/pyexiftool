...
class TestExifToolHelper(unittest.TestCase):
    ...
    def test_get_metadata(self):
        expected_data = [
            ...
            },  # older versions of exiftool used to display 70x46
            {
        ...
        ]  # older versions of exiftool used to display 64x64
        ...
        for expected, actual in zip(expected_data, actual_data):
            ...
            if isinstance(et_version, float):  # avoid exception in Py3k
                self.assertTrue(
                    et_version
                    >= 8.40,  # TODO there's probably a bug in this test, 8.40 == 8.4 which isn't the intended behavior
    ...
    def test_set_metadata(self):
        mod_prefix = "newcap_"
        expected_data = [
            {"SourceFile": "rose.jpg", "Caption-Abstract": "Ein Röschen ganz allein"},
    ...
    def test_set_keywords(self):
        ...
        mod_prefix = "newkw_"
        expected_data = [
            {"SourceFile": "rose.jpg", "Keywords": ["nature", "red plant"]}
        ]
        script_path = Path(__file__).parent
        source_files = []
        ...
        for d in expected_data:
            ...
            with self.et:
                self.et.set_keywords(
                    exiftool.helper.KW_REPLACE, d["Keywords"], f_mod_str
                )
