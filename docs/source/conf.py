...
latex_documents = [
    ("index", "PyExifTool.tex", u"PyExifTool Documentation", u"Sven Marnach", "manual"),
]
...
man_pages = [("index", "pyexiftool", u"PyExifTool Documentation", [u"Sven Marnach"], 1)]
